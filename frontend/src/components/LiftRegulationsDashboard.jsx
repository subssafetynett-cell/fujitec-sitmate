...
const STORAGE_PREFIXES = {
  stats: "site-mate:lr-monthly-stats:",
  incidents: "site-mate:lr-incidents:",
  targets: "site-mate:lr-scorecard-targets:",
  meta: "site-mate:lr-dashboard-meta:",
  snapshot: "site-mate:lr-incidents:",
};
...
export default function LiftRegulationsDashboard() {
  ...
  const {
    ...
    createDefaultStatRows: createDefaultLrStatRows,
    shouldSeedStatRows: shouldSeedDefaultLrKpis,
